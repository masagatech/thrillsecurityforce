            ...
            <div class="col-sm-7">
              <section class="b-type-a"><span class="b-type-a__icon">
                ...
                <div class="b-type-a__inner">
                  <h2 class="b-type-a__title"><span class="b-type-a__title_emphasis color-secondary">We Are Best</span> <br>Security Agency in Maharashtra!</h2>
                  <div class="b-type-a__text">We Maintain Very High Standard of Quality of Services.</div>
                </div>
              </section>
              <!-- end b-type-a-->
              ...
              <section class="b-type-b">
                ...
                <div class="b-type-b__inner">
                  ...
                  <div class="b-type-b__text">
                    <p>  We Thrill Security are one of the leading security company in the Kalyan,Maharashtra, India. As crime rates are increasing now a days times in various Indian cities, security has become a major concern. Whether you want personal security or security for your property or for your household members, you can contact us for reliable and proficient security services. Thrill security is a certified security service provider in Mumbai and in other parts of the state of Maharashtra.
Thrill Security  is Company established in 2018, is Mumbai’s most recognized and professionally qualified “Total Security / Manpower Solutions”. Thrill Security has come a long way in providing reliable and effective security solutions for the protection of life and property with a perfect blend of skills and resources. 
 </p>
                  </div>
            ...
            <div class="row">
              <div class="col-sm-4">
                ...
                <section class="b-advantages-1-item"><span class="b-advantages-1-item__decor"></span><i class="b-advantages-1-item__icon pe-7s-pin"></i>
                  <h3 class="b-advantages-1-item__title">Largest network, Best and Adequate Infrastructure,
Best Man Management Company.</h3>
              ...
              <div class="col-sm-4">
                <section class="b-advantages-1-item"><span class="b-advantages-1-item__decor"></span><i class="b-advantages-1-item__icon pe-7s-airplay"></i>
                  <h3 class="b-advantages-1-item__title">	Long terms association with Customers & Employees,
Maintains timely payments to its Employees,
Most Statutory Compliant Company</h3>
                  
                </section>
              </div>
              <div class="col-sm-4">
                <section class="b-advantages-1-item"><i class="b-advantages-1-item__icon pe-7s-diamond"></i>
                  <h3 class="b-advantages-1-item__title">Maintains very high Standard of quality of services
</h3>
            ...
            <div class="col-xs-12">
              <ul class="b-progress-list list-unstyled">
                <li class="b-progress-list__item clearfix">
                  <div class="b-progress-list__label">more than</div><span data-percent="1150" class="b-progress-list__percent js-chart"><span class="js-percent"></span></span><span class="b-progress-list__name">people guarded</span>
                </li>
                <li class="b-progress-list__item clearfix">
                  <div class="b-progress-list__label">more than</div><span data-percent="1000" class="b-progress-list__percent js-chart"><span class="js-percent"></span></span><span class="b-progress-list__name">homes protected</span>
                </li>
                <li class="b-progress-list__item clearfix">
                  <div class="b-progress-list__label">more than</div><span data-percent="120" class="b-progress-list__percent js-chart"><span class="js-percent"></span></span><span class="b-progress-list__name">events covered</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="section-default section-default_top-padd wow">
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-6"><img src="assets/img/thrill-security-min.jpg" alt="Foto" class="img-responsive"></div>
            <div class="col-sm-6">
              <div id="accordion-1" class="panel-group accordion accordion_marg-top_a">
                <h2> We live in a world that has walls and those walls need to be guarded by men with guns</h2>
              </div>
              <!-- end panel-->
          ...
          <div class="container">
            <div class="row">
              <div class="col-xs-12">
                ...
                <div class="b-type-c__subtitle">Look No Further -  Hire Thrill Security Services</div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-6">
              ...
              <div class="ui-subtitle-block ui-subtitle-block_mr-btm_sm">Thrill Security has over many years of experience as a security company.</div>
               <p> 
			   
			   The Company believes in quality service delivery standards’ 
			   with professional business administration and operations. 
			   The company is been operational since the year 2018 in name of <b>Thrill SECURITY </b >and is expanding with support of its satisfied clients.
			   As one of the most reputed Security Managements Service Provider Company in All Mumbai & Maharashtra. 
			   Recently it was brought to our knowledge that your organization is in the need of Security Manpower.  
                ...
                <div data-min480="1" data-min768="2" data-min992="2" data-min1200="3" data-pagination="false" data-navigation="true" data-auto-play="4000" data-stop-on-hover="true" class="owl-carousel owl-theme enable-owl-carousel">
                  <article class="b-reviews-1 b-reviews-1_mod-a">
                    ...
                    <blockquote class="blockquote blockquote-2">
                      <p> all security companies do a thorough verification of individuals before hiring them. They check employment records, personal references, and look for any prior criminal record..</p>
                  ...
                  <article class="b-reviews-1 b-reviews-1_mod-a">
                    ...
                    <blockquote class="blockquote blockquote-2">
                      <p>Excel Security Services in Dombivli East, Thane, Mumbai is a top player in the category Security Services For All India in the Thane, Mumbai.Security Services For All India, Security Services,Security Services For Office.</p>
                      <footer class="blockquote__footer">
      ...
      <div class="section-default wow">
        <div data-min480="1" data-min768="3" data-min992="5" data-min1200="5" data-pagination="false" data-navigation="false" data-auto-play="4000" data-stop-on-hover="true" class="b-brands owl-carousel owl-theme enable-owl-carousel">
          <div class="b-brands__item"><img src="assets/img/clients/1.png" alt="foto" class="img-responsive center-block"/></div>
          <div class="b-brands__item"><img src="assets/img/clients/2.jpg" alt="foto" class="img-responsive center-block"/></div>
          <div class="b-brands__item"><img src="assets/img/clients/3.png" alt="foto" class="img-responsive center-block"/></div>
          <div class="b-brands__item"><img src="assets/img/clients/4.png" alt="foto" class="img-responsive center-block"/></div>
          <div class="b-brands__item"><img src="assets/img/clients/5.png" alt="foto" class="img-responsive center-block"/></div>
        </div>
        <!-- end b-brands-->
          ...
          <div class="section__inner">
            <div class="b-form-request__inner">
              ...
              <div class="b-form-request__text">
                ...
                <p>We will respond with 2h hours OR call us at<strong> <?php echo($phone);?></strong></p>
              </div>
            </div>
            <form action="sendmail.php" method="POST" class="b-form-request__form">
              <div class="row">
                <div class="col-sm-6">
              ...
              <div class="row">
                <div class="col-xs-12">
                  <input type="text" name="address" placeholder="Service Location (Address)" class="form-control"/>
                </div>
              </div>
              <div class="row">
                <div class="col-xs-12">
                  <input type="text" name="zip" placeholder="Service Location (City, State, Zip Code)" class="form-control"/>
